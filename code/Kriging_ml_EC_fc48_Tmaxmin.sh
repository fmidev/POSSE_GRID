...
# Run out to 144h with 3h interval
ENDDTG=`$MANDTG $DTG + 144`
...
(sleep 1; echo "Kriging_fc_123 Start: `date`"; cd ${An_time}/fc_123; ../../MOStoECgrid_NC.R; echo "Kriging_fc_123 Done: `date`") &
(sleep 1; echo "Kriging_fc_126 Start: `date`"; cd ${An_time}/fc_126; ../../MOStoECgrid_NC.R; echo "Kriging_fc_126 Done: `date`") &
(sleep 1; echo "Kriging_fc_129 Start: `date`"; cd ${An_time}/fc_129; ../../MOStoECgrid_NC.R; echo "Kriging_fc_129 Done: `date`") &
(sleep 1; echo "Kriging_fc_132 Start: `date`"; cd ${An_time}/fc_132; ../../MOStoECgrid_NC.R; echo "Kriging_fc_132 Done: `date`") &
(sleep 1; echo "Kriging_fc_135 Start: `date`"; cd ${An_time}/fc_135; ../../MOStoECgrid_NC.R; echo "Kriging_fc_135 Done: `date`") &
(sleep 1; echo "Kriging_fc_138 Start: `date`"; cd ${An_time}/fc_138; ../../MOStoECgrid_NC.R; echo "Kriging_fc_138 Done: `date`") &
(sleep 1; echo "Kriging_fc_141 Start: `date`"; cd ${An_time}/fc_141; ../../MOStoECgrid_NC.R; echo "Kriging_fc_141 Done: `date`") &
(sleep 1; echo "Kriging_fc_144 Start: `date`"; cd ${An_time}/fc_144; ../../MOStoECgrid_NC.R; echo "Kriging_fc_144 Done: `date`") &
