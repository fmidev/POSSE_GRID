...
(sleep 1; echo "Kriging_fc_150 Start: `date`"; cd ${An_time}/fc_150; ../../MOStoECgrid_NC.R; echo "Kriging_fc_150 Done: `date`") &
(sleep 1; echo "Kriging_fc_156 Start: `date`"; cd ${An_time}/fc_156; ../../MOStoECgrid_NC.R; echo "Kriging_fc_156 Done: `date`") &
(sleep 1; echo "Kriging_fc_162 Start: `date`"; cd ${An_time}/fc_162; ../../MOStoECgrid_NC.R; echo "Kriging_fc_162 Done: `date`") &
(sleep 1; echo "Kriging_fc_168 Start: `date`"; cd ${An_time}/fc_168; ../../MOStoECgrid_NC.R; echo "Kriging_fc_168 Done: `date`") &
